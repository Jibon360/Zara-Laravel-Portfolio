...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Available All banner</h5>
                ...
                <tbody class="table-border-bottom-0">
                    @forelse ($banners as $banner)
                        <tr>
                            ...
                            <td>{{ $banner->title }}</td>
                            <td>{{ Str::limit($banner->descriptions, 20, ' (...)') }}</td>
                            ...
                            <td>
                                @isset($banner->updated_at)
                                    <ul>
                                        ...
                                        <li>{{ $banner->updated_at->diffForHumans() }}</li>
                                    </ul>
                                @endisset
                            </td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" style="">
                                        <a class="dropdown-item"
                                            href="{{ route('banner.edit', ['banner' => $banner->id]) }}"><i
